...
alias tezos-activate-001-Pt8PXNHh="$client  -block genesis activate protocol Pt8PXNHhxJxzNfSA1ZboJG7kD6i29aA7biRYang9HNH4KAUWqcx with fitness 1 and key activator and parameters $parameters_file --timestamp $(TZ='AAA+1' date +%FT%TZ)" ;
alias tezos-client-reset="rm -rf \"$client_dir\"; unalias tezos-activate-001-Pt8PXNHh tezos-client-reset" ;

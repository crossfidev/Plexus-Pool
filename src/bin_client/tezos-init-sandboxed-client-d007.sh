...
BOOTSTRAP1_IDENTITY="mp1KqTpEZ7Yob7QbPE4Hy4Wo8fHG8LhKxZSx"
...
BOOTSTRAP2_IDENTITY="mp1gjaF81ZRRvdzjobyfVNsAeSC6PScjfQwN"
...
BOOTSTRAP3_IDENTITY="mp1faswCTDciRzE4oJ9jn2Vm2dvjeyA9fUzU"
...
BOOTSTRAP4_IDENTITY="mp1b7tUupMgCNw2cCLpKTkSD1NZzB5TkP2sv"
...
BOOTSTRAP5_IDENTITY="mp1ddb9NMYHZi5UzPdzTZMYQQZoMub195zgv"
...
activate_001_Pt8PXNHh() {

    ${client} \
        -block genesis \
        activate protocol Pt8PXNHhxJxzNfSA1ZboJG7kD6i29aA7biRYang9HNH4KAUWqcx \
        with fitness 1 \
        and key activator \
...
main () {
    ...
    if [ $(basename "$bin_dir") = "bin_client" ]; then
        ...
        parameters_file="$bin_dir/../proto_001_Pt8PXNHh/parameters/sandbox-parameters.json"
...
alias mineplex-activate-001-Pt8PXNHh="$client  -block genesis activate protocol Pt8PXNHhxJxzNfSA1ZboJG7kD6i29aA7biRYang9HNH4KAUWqcx with fitness 1 and key activator and parameters $parameters_file --timestamp $(TZ='AAA+1' date +%FT%TZ)" ;
alias mineplex-client-reset="rm -rf \"$client_dir\"; unalias mineplex-activate-001-Pt8PXNHh mineplex-client-reset" ;
...
protocol as used by the alphanet by running:
  ...
  mineplex-activate-001-Pt8PXNHh

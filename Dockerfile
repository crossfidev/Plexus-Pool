...
COPY --chown=tezos:nogroup --from=builder /home/tezos/mineplex/mineplex-baker-* /home/tezos/bin/
COPY --chown=tezos:nogroup --from=builder /home/tezos/mineplex/mineplex-endorser-* /home/tezos/bin/
COPY --chown=tezos:nogroup --from=builder /home/tezos/mineplex/mineplex-accuser-* /home/tezos/bin/
COPY --chown=tezos:nogroup --from=builder /home/tezos/mineplex/mineplex-client /home/tezos/bin/
COPY --chown=tezos:nogroup --from=builder /home/tezos/mineplex/mineplex-admin-client /home/tezos/bin/
COPY --chown=tezos:nogroup --from=builder /home/tezos/mineplex/mineplex-node /home/tezos/bin/
COPY --chown=tezos:nogroup --from=builder /home/tezos/mineplex/mineplex-signer /home/tezos/bin/
...
COPY --chown=tezos:nogroup --from=intermediate /home/tezos/bin/mineplex-* /home/tezos/bin/
RUN strip /home/tezos/bin/mineplex*
